...
import styles from '../style/user_result.css';
...
export default class UserResult extends Component{
	...
	submit(){
		...
		axios.post('api/bill/reppwd',{
			token:user.token,
			dosubmit:1,
			oldpwd:this.state.oldPwd,
			npwd:this.state.newPwd,
			renpwd:this.state.newPwds
